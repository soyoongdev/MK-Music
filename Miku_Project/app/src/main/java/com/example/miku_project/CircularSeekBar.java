...
public class CircularSeekBar extends View {
    ...
    private void initAttributes(TypedArray attrArray) {
        ...
        int circleStyle = attrArray.getInt(me.tankery.lib.circularseekbar.R.styleable.cs_CircularSeekBar_cs_circle_style, DEFAULT_CIRCLE_STYLE);
        ...
        mPointerHaloColorOnTouch = attrArray.getColor(me.tankery.lib.circularseekbar.R.styleable.cs_CircularSeekBar_cs_pointer_halo_color_ontouch, DEFAULT_POINTER_HALO_COLOR_ONTOUCH);
        mCircleColor = attrArray.getColor(me.tankery.lib.circularseekbar.R.styleable.cs_CircularSeekBar_cs_circle_color, DEFAULT_CIRCLE_COLOR);
        mCircleProgressColor = attrArray.getColor(me.tankery.lib.circularseekbar.R.styleable.cs_CircularSeekBar_cs_circle_progress_color, DEFAULT_CIRCLE_PROGRESS_COLOR);
        mCircleFillColor = attrArray.getColor(me.tankery.lib.circularseekbar.R.styleable.cs_CircularSeekBar_cs_circle_fill, DEFAULT_CIRCLE_FILL_COLOR);

        mPointerAlpha = Color.alpha(mPointerHaloColor);

        mPointerAlphaOnTouch = attrArray.getInt(me.tankery.lib.circularseekbar.R.styleable.cs_CircularSeekBar_cs_pointer_alpha_ontouch, DEFAULT_POINTER_ALPHA_ONTOUCH);
        if (mPointerAlphaOnTouch > 255 || mPointerAlphaOnTouch < 0) {
            mPointerAlphaOnTouch = DEFAULT_POINTER_ALPHA_ONTOUCH;
        }

        mMax = attrArray.getInt(me.tankery.lib.circularseekbar.R.styleable.cs_CircularSeekBar_cs_max, DEFAULT_MAX);
        mProgress = attrArray.getInt(me.tankery.lib.circularseekbar.R.styleable.cs_CircularSeekBar_cs_progress, DEFAULT_PROGRESS);
        mCustomRadii = attrArray.getBoolean(me.tankery.lib.circularseekbar.R.styleable.cs_CircularSeekBar_cs_use_custom_radii, DEFAULT_USE_CUSTOM_RADII);
        mMaintainEqualCircle = attrArray.getBoolean(me.tankery.lib.circularseekbar.R.styleable.cs_CircularSeekBar_cs_maintain_equal_circle, DEFAULT_MAINTAIN_EQUAL_CIRCLE);
        mMoveOutsideCircle = attrArray.getBoolean(me.tankery.lib.circularseekbar.R.styleable.cs_CircularSeekBar_cs_move_outside_circle, DEFAULT_MOVE_OUTSIDE_CIRCLE);
        mLockEnabled = attrArray.getBoolean(me.tankery.lib.circularseekbar.R.styleable.cs_CircularSeekBar_cs_lock_enabled, DEFAULT_LOCK_ENABLED);
        mDisablePointer = attrArray.getBoolean(me.tankery.lib.circularseekbar.R.styleable.cs_CircularSeekBar_cs_disable_pointer, DEFAULT_DISABLE_POINTER);
        mNegativeEnabled = attrArray.getBoolean(me.tankery.lib.circularseekbar.R.styleable.cs_CircularSeekBar_cs_negative_enabled, DEFAULT_NEGATIVE_ENABLED);
        mIsInNegativeHalf = false;
        mDisableProgressGlow = attrArray.getBoolean(me.tankery.lib.circularseekbar.R.styleable.cs_CircularSeekBar_cs_disable_progress_glow, DEFAULT_DISABLE_PROGRESS_GLOW);
        mHideProgressWhenEmpty = attrArray.getBoolean(me.tankery.lib.circularseekbar.R.styleable.cs_CircularSeekBar_cs_hide_progress_when_empty, DEFAULT_CS_HIDE_PROGRESS_WHEN_EMPTY);

        // Modulo 360 right now to avoid constant conversion
        mStartAngle = ((360f + (attrArray.getFloat((me.tankery.lib.circularseekbar.R.styleable.cs_CircularSeekBar_cs_start_angle), DEFAULT_START_ANGLE) % 360f)) % 360f);
        mEndAngle = ((360f + (attrArray.getFloat((me.tankery.lib.circularseekbar.R.styleable.cs_CircularSeekBar_cs_end_angle), DEFAULT_END_ANGLE) % 360f)) % 360f);
        ...
        // Modulo 360 right now to avoid constant conversion
        mPointerAngle = ((360f + (attrArray.getFloat((me.tankery.lib.circularseekbar.R.styleable.cs_CircularSeekBar_cs_pointer_angle), DEFAULT_POINTER_ANGLE) % 360f)) % 360f);
        if (mPointerAngle == 0f) {
...
//            }
    ...
    private void init(AttributeSet attrs, int defStyle) {
        final TypedArray attrArray = getContext().obtainStyledAttributes(attrs, me.tankery.lib.circularseekbar.R.styleable.cs_CircularSeekBar, defStyle, 0);
