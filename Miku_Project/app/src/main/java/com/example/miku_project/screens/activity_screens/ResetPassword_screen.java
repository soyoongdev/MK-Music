...
public class ResetPassword_screen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_send_email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (email.equals("")){
                    Toast.makeText(ResetPassword_screen.this, "Enter your mail address to reset password", Toast.LENGTH_SHORT).show();
                }else {
                    startCountdownTimer();
        ...
        public void onResponse(Call<ResponseModel> call, retrofit2.Response<ResponseModel> response) {
            if (response.isSuccessful()){
                ...
                if (responseModel.getStatus()){
                    Toast.makeText(ResetPassword_screen.this, "Check your email to reset password!", Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(ResetPassword_screen.this, "Failed", Toast.LENGTH_SHORT).show();
                }
            }
        }
    ...
    private void startCountdownTimer(){
        countDownTimer = new CountDownTimer(30000, 1000) {
            ...
            public void onFinish() {
                Toast.makeText(ResetPassword_screen.this, "Time out! Request again to reset password", Toast.LENGTH_SHORT).show();
    ...
    private void initView() {
        ...
        String getEmail = RootData.getPrefUserData(ResetPassword_screen.this).getEmail();

        if (!getEmail.isEmpty()) {
            edt_email_reset.setText(getEmail);
        }
    }
}